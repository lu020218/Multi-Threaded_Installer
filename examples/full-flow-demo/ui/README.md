...
| `welcome.license_notice` | Welcome page license prefix text |
| `welcome.license_link` | Welcome page license link label |
...
| `button.quick_install` | Quick install button label |
| `button.custom_options` | Custom options button label |
